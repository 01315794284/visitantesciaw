...
class UserController extends Controller
{
    ...
    private $countEEExit;
    private $avgIncome;
    const SESSION = 'USER_ciaw_SECRET';
    ...
    public function recordExitciaw ($request, $response, $args)
    {
    ...
    public function recordExitciawForUpdate ($request, $response, $args)
    {
    ...
    public function exportedInPDF ()
    {
        ...
        $fileName = 'ReportDatasciaw' . str_replace(':','',date('H:i:s'));
        ...
        $mpdf->imageVars['imageciaw'] = file_get_contents($pathDef . '/Storage/site/banner/img01.jpg');
            ...
            <div id="content">
                ...
                <div id="mainInfo">
                    ...
                    <div id="topHome">
                        ...
                        <div id="topHomeRight">
                            <img src="var:imageciaw" style="width: 100%;
                            height: 250px;object-fit: cover;" alt="Banner do ciaw">
                            <div>
                                 <h1 style="
                                 top: 145px;
                                 right: 70%;
        ...
        $mpdf->SetHeader('{DATE j/m/Y}|{PAGENO}/{nbpg}|ciaw'); //Cabeçalho
